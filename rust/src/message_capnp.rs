...
pub mod header {
  ...
  mod _private {
    ...
    pub const TYPE_ID: u64 = 0xa012_2bd2_588b_621c;
  }
}
...
pub mod request {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_headers(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::message_capnp::header::Owned>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(1), ::core::option::Option::None)
    }
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_seqid(&mut self, value: i32)  {
    ...
    #[inline]
    pub fn set_uri(&mut self, value: ::capnp::text::Reader<'_>)  {
      self.builder.get_pointer_field(0).set_text(value);
    }
    #[inline]
    ...
    #[inline]
    pub fn get_headers(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::message_capnp::header::Owned>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_headers(&mut self, value: ::capnp::struct_list::Reader<'a,crate::message_capnp::header::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(1), value, false)
    }
    #[inline]
    pub fn init_headers(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::message_capnp::header::Owned> {
  ...
  mod _private {
    ...
    pub const TYPE_ID: u64 = 0x94f5_4375_50d4_224e;
  }
}
...
pub mod response {
  ...
  mod _private {
    ...
    pub const TYPE_ID: u64 = 0xb103_35d5_c6c3_f186;
  }
}
